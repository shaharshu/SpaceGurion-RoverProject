...
// The motors[] array is defined in SixMotorController.cpp.
// Declared extern here so the .ino sketch (and others) can access it directly,
// the same way the servos array is used.
extern DCmotor motors[DCmotor_COUNT];
